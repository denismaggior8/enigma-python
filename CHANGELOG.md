...
### Changed
- **Renaming**: Renamed `notch_index`/`ex` to `turnover_index`/`es` globally for better technical clarity.
- **Dynamic Turnover**: Refined internal logic to support customizable turnover functions via injectable lambdas.
