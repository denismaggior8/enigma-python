...
### Changed
- **Enigma**: Refactored rotor indexing during double stepping by utilizing `enumerate()` instead of list `.index()`, optimizing it and preventing unexpected list index lookup issues on MicroPython.

### Fixed
- **Rotor**: Removed redundant and incorrect `__eq__` operator overload.
