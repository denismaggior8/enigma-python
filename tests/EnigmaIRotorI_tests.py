...
class TestEnigmaIRotorI(unittest.TestCase):
    ...
    def test_rotor_set_position_and_ring_position(self):
        ...
        scrambled_char = rotor.scramble_letter_index(rotor.wiring,list(ascii_lowercase).index('z'),rotor.position)
